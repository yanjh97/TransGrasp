...
p.add_argument('--config', type=str,default='DIF_decoder/configs/train/mug.yml', help='training configuration.')
p.add_argument('--train_split', type=str,default='', help='training subject names.')

p.add_argument('--logging_root', type=str, default='./DIF_decoder/logs', help='root for logging')
...
data_path = [os.path.join(meta_params['point_cloud_path'],f + '.mat') for f in all_names] # eg. datasets/car/surface_pts_n_normal
